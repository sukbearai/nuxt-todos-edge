      ...
      <div class="user-info">
        ...
        <div class="flex items-center">
          ...
          >
            <img
              class="w-full h-full"
              src="https://cdn.jsdelivr.net/gh/sukbearai/skills-graph@main/example/widget.png"
              alt=""
            >
          </div>
          <p class="bio">
      ...
      <div class="skills">
        <div class="stage">
          ...
          >
            <NuxtLink
              target="_blank"
              href="https://cdn.jsdelivr.net/gh/sukbearai/skills-graph@main/example/sponsors.circles.svg"
            >
              <NuxtImg src="https://cdn.jsdelivr.net/gh/sukbearai/skills-graph@main/example/sponsors.circles.svg" />
            </NuxtLink>
          </div>
          <div>
            <NuxtLink
              target="_blank"
              href="https://cdn.jsdelivr.net/gh/sukbearai/skills-graph@main/example/sponsors.wide.svg"
            >
              <NuxtImg src="https://cdn.jsdelivr.net/gh/sukbearai/skills-graph@main/example/sponsors.wide.svg" />
            </NuxtLink>
          </div>
        </div>
      </div>
